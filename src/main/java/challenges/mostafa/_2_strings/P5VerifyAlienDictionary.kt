...
internal object P5VerifyAlienDictionary {
     ...
     *
     * Lexicographical order, also known as lexical order or dictionary order, is essentially a way of ordering sequences of elements (like words, numbers, or other symbols) based on the order of their component elements. Here's a breakdown:
     *
     * Core Concept:
     *
